...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const entries = <_HomeEntry>[
      _HomeEntry('🔤', 'Dunia Huruf', KidsTheme.pink),
      _HomeEntry('🔢', 'Dunia Angka', KidsTheme.primary),
      _HomeEntry('🕌', 'Dunia Hijaiyah', KidsTheme.green),
      _HomeEntry('🐱', 'Dunia Gambar', KidsTheme.orange),
      _HomeEntry('🎨', 'Dunia Warna', KidsTheme.purple),
      _HomeEntry('🖍️', 'Mewarnai', KidsTheme.pink),
      _HomeEntry('🔗', 'Titik & Garis', KidsTheme.yellow),
      _HomeEntry('🧠', 'Kuis Seru', KidsTheme.purple),
    ];
                      ...
                      children: [
                        ...
                        GridView.builder(
                          ...
                          gridDelegate:
                            ...
                            crossAxisSpacing: 12,
                            mainAxisSpacing: 12,
                            childAspectRatio: columns == 2 ? 1.05 : 1,
                          ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              ...
              ValueListenableBuilder<bool>(
                ...
                builder: (_, enabled, __) => _SoundButton(
                  on: enabled,
                  onTap: () {
                    music.toggle();
          ...
          const SizedBox(height: 4),
          Text('🐼', style: TextStyle(fontSize: compact ? 54 : 66)),
        ],
      ),
    );
  }
...
class _SoundButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      color: on ? KidsTheme.green : KidsTheme.muted,
      shape: const CircleBorder(),
      elevation: 2,
      child: InkWell(
        customBorder: const CircleBorder(),
        ...
        child: const SizedBox(
          width: 54,
          height: 54,
          child: Icon(Icons.volume_up_rounded, color: Colors.white, size: 29),
        ),
      ),
    );
  }
...
class _HomeEntry {
  ...
  const _HomeEntry(this.emoji, this.title, this.color);
}
            ...
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    entry.emoji,
                    style: TextStyle(fontSize: compact ? 39 : 46),
                  ),
                ),
              ),
              ...
              Icon(Icons.arrow_forward_rounded, color: entry.color, size: 22),
            ],
          ),
        ),
      ),
