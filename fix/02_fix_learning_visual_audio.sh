...
echo "==> Memperbaiki visual Learning dan audio"

cat > lib/core/services/audio_service.dart <<'DART'
...
cat > lib/features/learning/learning_page.dart <<'DART'
import 'dart:math';
...
git add -f fix/02_fix_learning_visual_audio.sh

git commit -m "fix: improve learning visuals and faster audio"

git push origin "$(git branch --show-current)"

echo "==> Selesai dan sudah push"
